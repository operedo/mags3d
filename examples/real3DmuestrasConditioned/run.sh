...
## Lanzar una simulacion fwd sin datos condicionantes
#modefwd=3 
##echo "./mags3d.exe ${nx} ${ny} ${nz} ${xlo} ${ylo} ${zlo} ${h} ${a} ${modefwd}"
#$MAGS3D_HOME/bin/mags3dConditioned.exe ${nx} ${ny} ${nz} ${xlo} ${ylo} ${zlo} ${h} ${a} ${modefwd}
###
...
/usr/bin/time $MAGS3D_HOME/bin/mags3dConditioned.exe ${nx} ${ny} ${nz} ${xlo} ${ylo} ${zlo} ${h} ${a} ${modefwd} ${mu} 2> salida.txt & 
#
